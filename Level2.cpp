...
//TODO
Level2::Level2(int& vol, int highscore) : Levels(14, 250, 14, 1.0f, 0.45f, "", highscore, vol) {
	...
	levelTime = 210.0f; //3.5 mins for this level
	numRings = 25; //adjust
	numLives = 3; //adjust
	numBoosts = 2; //adjust
	teamHealth = 5;
...
void Level2::createBackground() {
	lvlBgTex[0].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[1].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[2].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[3].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[4].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[5].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[6].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[7].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[8].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[9].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[10].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[11].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[12].loadFromFile("Backgrounds\\lvl2_bg.png");
	lvlBgTex[13].loadFromFile("Backgrounds\\lvl2_bg.png");
...
{
	wallTex1.loadFromFile("Sprites\\ice_block_sprite.png");
...
void Level2::createCollectibles()
{
...
void Level2::drawCollectibles(RenderWindow& window)
{
	for (int i = 0; i < 14; i++) {
		for (int j = 0; j < 250; j++) {
...
void Level2::drawObstacles(RenderWindow& window)
{
...
void Level2::runLevel(RenderWindow& window) {
...
void Level2::switchActivePlayer()
{
...
void Level2::followActivePlayer(int i, RenderWindow& window)
{
...
//TODO
void Level2::flyWithTails(int i, RenderWindow& window)
{
	if (i == 1)
		return;
